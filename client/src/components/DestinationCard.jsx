  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between mb-3">
        <span className={`text-xs px-2.5 py-1 rounded-full text-white ${getCategoryBadgeClass(destination.Category)}`}>
      ...
      {/* Place Name */}
      <h3 className="text-lg font-semibold text-white mb-3 line-clamp-2 group-hover:text-blue-400 transition-colors duration-200">
      ...
      <div className="flex items-center justify-between pt-3 border-t border-white/10">
        ...
        {/* Price */}
        <div className={`text-sm font-semibold ${destination.Price === 0 ? 'text-green-400' : 'text-blue-400'}`}>
