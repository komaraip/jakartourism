    ...
    <section id="search" className="py-20 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-warmgray text-lg max-w-2xl mx-auto mb-8">
        ...
        <div id="search-results" className="mt-8">
          ...
          {isLoadingRecommendations && (
            <div className="flex items-center justify-center py-16">
              <div className="text-center">
                ...
                <p className="text-warmgray font-medium">Memuat data...</p>
              </div>
            </div>
          )}
          ...
          {!isLoadingRecommendations && selectedDestination && (
            <div className="bg-surface-50 rounded-3xl p-4 md:p-8 mt-8">
