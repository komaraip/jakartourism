  ...
  return (
    <section className="px-4 py-10 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="font-heading text-2xl font-bold text-charcoal">Tentang Tempat Ini</h2>
      </div>
      ...
      <div className="modern-card p-6 md:p-8">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
          ...
          <div className="text-right">
            <div className="text-sm text-warmgray mb-1 font-medium">Harga Tiket</div>
        ...
        {/* Rating */}
        <div className="flex items-center gap-2 mb-6 pb-6 border-b border-primary-50">
          <div className="flex">{renderStars(destination.Rating)}</div>
          <span className="text-lg font-bold text-charcoal">{destination.Rating}</span>
          <span className="text-warmgray">/ 5.0</span>
        </div>

        {/* Description */}
        <div className="mb-6">
          <h4 className="font-heading text-lg font-bold text-charcoal mb-3">Deskripsi</h4>
        ...
        {/* Location Info */}
        <div className="flex flex-wrap gap-4 pt-4 border-t border-primary-50">
          <div className="flex items-center gap-2 text-warmgray">
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-secondary-100 to-secondary-200 flex items-center justify-center">
