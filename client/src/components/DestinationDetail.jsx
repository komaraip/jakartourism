  ...
  const renderStars = (rating) => {
    ...
    for (let i = 0; i < 5; i++) {
      if (i < fullStars) {
        ...
        stars.push(
          <svg key={i} className="w-5 h-5 text-gray-600" fill="currentColor" viewBox="0 0 20 20">
            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
          </svg>
        );
      }
  ...
  return (
    <section className="px-4 py-8 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-2xl font-bold text-white">Tentang Tempat Ini</h2>
      </div>
      ...
      <div className="glass-card p-6 md:p-8">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
          <div>
            ...
            <span className={`inline-block text-sm px-3 py-1 rounded-full text-white ${getCategoryBadgeClass(destination.Category)}`}>
          ...
          <div className="text-right">
            ...
            <div className={`text-2xl font-bold ${destination.Price === 0 ? 'text-green-400' : 'text-white'}`}>
        ...
        {/* Description */}
        <div className="mb-6">
          <h4 className="text-lg font-semibold text-white mb-2">Deskripsi</h4>
